...
describe("favorite post", () => {
  test("returns empty array when there isnt blogs", () => {
    const emptyList = [];
...
describe("author with most blogs written", () => {
  test("returns empty array when there isn't blogs", () => {
    const emptyList = [];
    const result = listHelper.mostBlogs(emptyList);
    expect(result).toEqual(emptyList);
  });

  test("expect to return the author with most blogs", () => {
...
describe("author with most likes in their posts", () => {
  test("returns empty array when there isn't blogs", () => {
    const emptyList = [];
